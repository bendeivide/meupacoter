...
Por fim, precisamos fazer o download para o [$\LaTeX$](http://miktex.org/download), para desenvolvermos a documentação do pacote. Caso não deseje fazer essa instalação, uma alternativa é instalar o pacote [tinytex](http://cran.r-project.org/package=tinytex), usando o código:
...
Passos no [RStudio](https://rstudio.com/): `File` >  `New Project...` > `New Directory` > `R package`. Insira o nome do pacote e armazene o projeto em um diretório desejado.
